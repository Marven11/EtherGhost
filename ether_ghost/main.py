...
@app.get("/sessiontype/{session_type}/conn_options")
@catch_user_error
...
@app.get("/connectortype/{connector_name}/conn_options")
@catch_user_error
...
@app.get("/connector/{connector_id}/start")
@catch_user_error
...
@app.get("/connector/{connector_id}/stop")
@catch_user_error
